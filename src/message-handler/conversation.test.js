...
describe('message-handler/conversation', function() {

  it('should export the proper API', function() {
    expect(createConversation).to.be.a('function');
    expect(ConversingMessageHandler).to.be.a('function');
  });

  describe('createConversation', function() {

    it('should return an instance of ConversingMessageHandler', function() {
